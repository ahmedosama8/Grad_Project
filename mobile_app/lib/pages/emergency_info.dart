...
class _EmergencyInfoPage extends State<EmergencyInfoPage> {
  ...
  List<String> bloodTypesItems = ['AB+' , 'AB-' ,'A+','A-','B+','B-','O+','O-'];
  ...
  List<String> chronicDiseaseItems = ['I dont have any chronic diseases','Heart Disease' , 'Cancer' ,'Lung Disease','Stroke','Alzheimer','Diabetes','kidney Disease','Other'];
  ...
  List<String> martialItems = ['Married','Divorced','Separeted or Widowed','Single'];
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: DropdownButtonFormField(
                        ...
                        isExpanded: true,
                      items: bloodTypesItems.map<DropdownMenuItem<String>>((String selectedBloodVal)
                      {
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: DropdownButtonFormField(
                        ...
                        isExpanded: true,
                      items: chronicDiseaseItems.map<DropdownMenuItem<String>>((String selectedDiseaseVal)
                      {
                        return DropdownMenuItem<String>(
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: DropdownButtonFormField(
                        ...
                        isExpanded: true,
                      items: martialItems.map<DropdownMenuItem<String>>((String selectedStatusVal)
                      {
                        return DropdownMenuItem<String>(
